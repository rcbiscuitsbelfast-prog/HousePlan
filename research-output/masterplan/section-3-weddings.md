...
## Section 3: The Wedding Market — Competitive Analysis & Fernhill's Opportunity
...
```json
{
  "agent": "wedding-agent",
  "version": "1.0.0",
  "generated": "2026-05-08T07:24:20.291Z",
  "status": "scaffold — populate via AI research run"
}
```

*Full research data available in /research-output/weddings/weddings.json*
